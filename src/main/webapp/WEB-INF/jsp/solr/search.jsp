...
<body>
	<form action="search.do" method="post">
		<input name="num" value="1" type="hidden" /> <input name="keywords"
			maxlength="30" value="${keywords }"/> <input type="submit" value="千度一下" />
	</form>
	<br />
...
千度为您找到相关结果约${page.rowCount }个
    ...
    <br />
		...
		<c:forEach begin="${page.everyPageStart}" end="${page.everyPageEnd}"
			var="current">
			<c:choose>
